  ...
  Main = (function() {
    ...
    Main.prototype.fixIEPatterns = function() {
      ...
      this.addImageToPattern({
        pattern: 'pattern2',
        image: 'https://s3-us-west-2.2.amazonaws.com/s.cdpn.io/6859/pattern2.png'
      });
      this.addImageToPattern({
        pattern: 'pattern3',
        image: 'https://s3-us-west-2.2.amazonaws.com/s.cdpn.io/6859/pattern3.png'
      });
      this.addImageToPattern({
        pattern: 'pattern4',
        image: 'https://s3-us-west-2.2.amazonaws.com/s.cdpn.io/6859/pattern4.png'
      });
      return this.addImageToPattern({
        pattern: 'pattern5',
        image: 'https://s3-us-west-2.2.amazonaws.com/s.cdpn.io/6859/pattern5.png'
      });
    };
