...
$options = array(
   'token'=>'rashly', //填写你设定的key
   'encodingaeskey'=>'XoPDzb7HWjpn7cGPXQ84dRdeUDSXIfwpFgeyzw3Yspb', //填写加密用的EncodingAESKey
   'appid'=>'wxb10424f3653c7164', //填写高级调用功能的app id
   'appsecret'=>'5fdc1ebdddb1bab2cbebab88361a2192' //填写高级调用功能的密钥
 );
...
( 
  array
  ( 
    'Title'=>"欢迎光临任雨林的微信公众平台", 
    'PicUrl'=>'http://www.fangyue.site/wechat/image/welcome.jpg', 
    'Url'=>'http://www.fangyue.site/wechat/renyulin/time/index.html'
   )//,    
  // array
  // ( 
