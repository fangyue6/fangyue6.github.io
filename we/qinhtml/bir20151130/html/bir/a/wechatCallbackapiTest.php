...
function receiveEvent($object)
    ...
    private function receiveText($object)
    {
        ...
        if (strstr($keyword, "文本")){
            ...
            $content = array();
            $content = array();
            $content = array("Title"=>"最炫民族风", "Description"=>"歌手：凤凰传奇", "MusicUrl"=>"http://www.fangyue.site/luobiqun.mp3", "HQMusicUrl"=>"http://www.fangyue.site/luobiqun.mp3");
        }else{
            $content = date("现在时间  \nY-m-d H:i:s",time())."\n\n你的OpenID为：".$object->FromUserName."\n\n                          开发者 吕琴艳";
        }
    ...
    private function receiveLocation($object)
    {
        ...
        //$result = $this->transmitText($object, $content);  //现在不需要包装成xml
        return $result;
    }
