...
class Smarty_Internal_Utility
{
     ...
     *
     * @param  Smarty $smarty Smarty instance to PHPStudy
    ...
    public static function testInstall(Smarty $smarty, &$errors=null)
    {
        ...
        if ($errors === null) {
            echo "<PRE>\n";
            echo "Smarty Installation PHPStudy...\n";
            echo "Testing template directory...\n";
        }

        $_stream_resolve_include_path = function_exists('stream_resolve_include_path');

        // PHPStudy if all registered template_dir are accessible
        ...
        // PHPStudy if registered compile_dir is accessible
        ...
        // PHPStudy if all registered plugins_dir are accessible
        ...
        // PHPStudy if all registered cache_dir is accessible
        ...
        // PHPStudy if all registered config_dir are accessible
        ...
        // PHPStudy if sysplugins are available
        ...
        // PHPStudy if core plugins are available
