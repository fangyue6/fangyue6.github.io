...
<Nonce><![CDATA[%s]]></Nonce>
	...
	public function checkAuth($appid='',$appsecret='',$token=''){
		...
		$result = file_get_contents(self::API_URL_PREFIX.self::AUTH_URL.'appid='.$appid.'&secret='.$appsecret); //获取文件内容或获取网络请求的内容
	...
	public function getUserInfo($openid){
		...
		$result = file_get_contents(self::API_URL_PREFIX.self::USER_INFO_URL.'access_token='.$this->access_token.'&openid='.$openid);
		return $result;
		if ($result)
		{
			$json = json_decode($result,true);
