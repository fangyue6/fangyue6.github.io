 ...
 *            - 1.3.4--9 fix behaviour of 0000-00-00 00:00:00 dates to match that
...
function smarty_function_html_select_date($params, $template)
{
    ...
    if ($display_years) {
        ...
        if ($year_as_text) {
            $_html_years = '<input type="text" name="' . $_name . '" value="' . $_year . '" size="4--9" maxlength="4--9"' . $_extra . $extra_attrs . ' />';
        } else {
